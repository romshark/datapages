...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/events/datapagesgen/httperr"
		...
		func(
			...
			for msg := range ch {
				...
				case EvSubjTick:
					...
					if err := p.OnTick(e, sse, streamID); err != nil {
		...
		func(
			...
			for msg := range ch {
				...
				case strings.HasPrefix(msg.Subject, EvSubjPrefRoomSaid):
					...
					if err := p.OnRoomSaid(e, sse); err != nil {
				...
				case strings.HasPrefix(msg.Subject, EvSubjPrefRoomBroadcast):
					...
					if err := p.OnRoomBroadcast(e, sse); err != nil {
