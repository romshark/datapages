...
func POSTPageIndexTick(options ...option) string {
	...
	b.Grow(bl + len("@post('/tick/'") + optionsLen(options) + len(")") + al)
...
func POSTPageRoomBroadcast(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/room/broadcast/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageRoomSay(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/room/say/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
