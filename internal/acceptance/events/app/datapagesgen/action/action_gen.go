...
func POSTPageIndexBoth(options ...option) string {
	...
	b.Grow(bl + len("@post('/both/'") + actionexpr.OptionsLen(options) + len(")") + al)
...
func POSTPageIndexCanceled(options ...option) string {
	...
	var b strings.Builder
	bl, al := actionexpr.BeforeAfterLen(options)
	b.Grow(bl + len("@post('/canceled/'") + actionexpr.OptionsLen(options) + len(")") + al)
	actionexpr.WriteBefore(&b, options)
...
func POSTPageRoomBroadcast(options ...option) string {
	...
	var b strings.Builder
	bl, al := actionexpr.BeforeAfterLen(options)
	b.Grow(bl + len("@post('/room/broadcast/'") + actionexpr.OptionsLen(options) + len(")") + al)
	actionexpr.WriteBefore(&b, options)
	b.WriteString("@post('/room/broadcast/'")
	actionexpr.WriteOptions(&b, options)
	b.WriteByte(')')
	actionexpr.WriteAfter(&b, options)
	return b.String()
...
func POSTPageRoomSay(options ...option) string {
	...
	var b strings.Builder
	bl, al := actionexpr.BeforeAfterLen(options)
	b.Grow(bl + len("@post('/room/say/'") + actionexpr.OptionsLen(options) + len(")") + al)
	actionexpr.WriteBefore(&b, options)
	b.WriteString("@post('/room/say/'")
	actionexpr.WriteOptions(&b, options)
	b.WriteByte(')')
	actionexpr.WriteAfter(&b, options)
	return b.String()
