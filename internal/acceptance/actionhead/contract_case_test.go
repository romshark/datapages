...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/actionhead/app/datapagesgen"
	"github.com/romshark/datapages/internal/acceptance/actionhead/app/datapagesgen/action"
...
func TestContract(t *testing.T) {
	contract.Run(t, contract.Case{
		...
		Actions:        []string{action.PageIndex.Render.POST()},
		OptionedAction: action.PageIndex.Render.POST(
