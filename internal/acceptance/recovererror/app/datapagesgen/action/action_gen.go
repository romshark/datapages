...
func POSTPageIndexBad(options ...option) string {
	...
	b.Grow(bl + len("@post('/bad/'") + optionsLen(options) + len(")") + al)
...
func POSTPageIndexMissing(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/missing/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageIndexPlain(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/plain/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageIndexUnrecoverable(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/unrecoverable/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
