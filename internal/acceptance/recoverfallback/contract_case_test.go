// Wires the recoverfallback case into the shared contract suite.
...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/recoverfallback/app/datapagesgen"
	"github.com/romshark/datapages/internal/acceptance/recoverfallback/app/datapagesgen/action"
...
func TestContract(t *testing.T) {
	contract.Run(t, contract.Case{
		...
		Actions:        []string{action.PageIndex.Bad.POST()},
