...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/getsignals/datapagesgen/httperr"
...
func (s *Server) handlePageEnterGET(w http.ResponseWriter, r *http.Request) {
	...
	if err := s.writeHTML(
		w, r, app.Session{}, nil, body, bodyAttrs, nil,
	); err != nil {
...
func (s *Server) handlePageIndexPOSTLeave(
	...
	closeSession, err := p.POSTLeave(r, sessToken)
	if err != nil {
