...
func POSTPageLoginBroadcast(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/login/broadcast/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageLoginNotify(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/login/notify/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageLoginRename(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/login/rename/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
