...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/actionoptions/app/datapagesgen"
...
func TestContract(t *testing.T) {
	contract.Run(t, contract.Case{
		...
		Actions:        []string{action.PageIndex.Save.POST()},
		OptionedAction: action.PageIndex.Save.POST(
