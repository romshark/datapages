// Wires the actionoptions case into the shared contract suite.
...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/actionoptions/app"
	"github.com/romshark/datapages/internal/acceptance/actionoptions/datapagesgen"
	"github.com/romshark/datapages/internal/acceptance/actionoptions/datapagesgen/action"
	"github.com/romshark/datapages/internal/acceptance/actionoptions/datapagesgen/href"
...
func TestContract(t *testing.T) {
	contract.Run(t, contract.Case{
		...
		Actions:        []string{action.POSTPageIndexSave()},
		OptionedAction: action.POSTPageIndexSave(
