...
func POSTPageRoomsNotice(options ...option) string {
	...
	b.Grow(bl + len("@post('/rooms/notice/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
	b.WriteString("@post('/rooms/notice/'")
...
func POSTPageRoomsPost(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/rooms/post/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageTabsBump(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/tabs/bump/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
