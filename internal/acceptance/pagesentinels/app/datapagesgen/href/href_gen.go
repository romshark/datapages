...
// PageBad references /bad-request/{$}
func PageBad() string { return "/bad-request/" }

// PageConflict references /conflict/{$}
func PageConflict() string { return "/conflict/" }
...
// PagePlain references /plain/{$}
func PagePlain() string { return "/plain/" }
