...
// POSTPageCountBump references /count/bump/
func POSTPageCountBump(options ...option) string {
	if len(options) == 0 {
		return "@post('/count/bump/')"
	}
	var b strings.Builder
	bl, al := actionexpr.BeforeAfterLen(options)
	b.Grow(bl + len("@post('/count/bump/'") + actionexpr.OptionsLen(options) + len(")") + al)
	actionexpr.WriteBefore(&b, options)
	b.WriteString("@post('/count/bump/'")
...
// POSTPageLabelSet references /label/set/
func POSTPageLabelSet(options ...option) string {
	if len(options) == 0 {
		return "@post('/label/set/')"
	}
	var b strings.Builder
	bl, al := actionexpr.BeforeAfterLen(options)
	b.Grow(bl + len("@post('/label/set/'") + actionexpr.OptionsLen(options) + len(")") + al)
	actionexpr.WriteBefore(&b, options)
	b.WriteString("@post('/label/set/'")
	actionexpr.WriteOptions(&b, options)
	b.WriteByte(')')
	actionexpr.WriteAfter(&b, options)
	return b.String()
...
func POSTPageNestedBump(options ...option) string {
	...
	var b strings.Builder
	bl, al := actionexpr.BeforeAfterLen(options)
	b.Grow(bl + len("@post('/nested/bump/'") + actionexpr.OptionsLen(options) + len(")") + al)
	actionexpr.WriteBefore(&b, options)
...
func POSTPagePointerBump(options ...option) string {
	...
	var b strings.Builder
	bl, al := actionexpr.BeforeAfterLen(options)
	b.Grow(bl + len("@post('/pointer/bump/'") + actionexpr.OptionsLen(options) + len(")") + al)
	actionexpr.WriteBefore(&b, options)
