// Wires the recovererroralone case into the shared contract suite.
...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/recovererroralone/app/datapagesgen"
	"github.com/romshark/datapages/internal/acceptance/recovererroralone/app/datapagesgen/action"
	"github.com/romshark/datapages/internal/acceptance/recovererroralone/app/datapagesgen/href"
...
func TestContract(t *testing.T) {
	contract.Run(t, contract.Case{
		...
		Actions:        []string{action.PageIndex.Fail.POST()},
