...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/minimal/datapagesgen/httperr"
...
func (s *Server) handlePageIndexPOSTPing(
	...
	dispatch := func(
	...
	) error {
		{
			...
			err = s.messageBroker.Publish(r.Context(), s.messageBrokerMetrics, EvSubjPing, j)
			if err != nil {
	...
	err := p.POSTPing(r, signals, dispatch)
	if err != nil {
