...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/minimal/app/datapagesgen/action"
	"github.com/romshark/datapages/internal/acceptance/minimal/app/datapagesgen/href"
...
func TestContract(t *testing.T) {
	contract.Run(t, contract.Case{
		...
		StreamPath:     "/_$/",
		DispatchAction: action.PageIndex.Ping.POST(),
		DispatchBody:   `{"n":1}`,
		Actions:        []string{action.PageIndex.Ping.POST()},
		SignalActions:  []string{action.PageIndex.Ping.POST()},
		OptionedAction: action.PageIndex.Ping.POST(
