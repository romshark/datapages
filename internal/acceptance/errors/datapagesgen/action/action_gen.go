...
func POSTPageBoomBad(options ...option) string {
	...
	b.Grow(bl + len("@post('/boom/bad/'") + optionsLen(options) + len(")") + al)
...
func POSTPageBoomConflict(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/boom/conflict/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageBoomForbidden(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/boom/forbidden/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageBoomNotFound(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/boom/not-found/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageBoomPlain(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/boom/plain/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
...
func POSTPageBoomWrapped(options ...option) string {
	...
	var b strings.Builder
	bl, al := beforeAfterLen(options)
	b.Grow(bl + len("@post('/boom/wrapped/'") + optionsLen(options) + len(")") + al)
	writeBefore(&b, options)
