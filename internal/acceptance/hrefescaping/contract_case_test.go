// Wires the hrefescaping case into the shared contract suite.
...
import (
	...
	"github.com/romshark/datapages/internal/acceptance/hrefescaping/app/datapagesgen"
...
func TestContract(t *testing.T) {
	contract.Run(t, contract.Case{
		...
		Links: []string{
			href.PageIndex(),
			href.PageItem("plain"),
			href.PageSearch(href.QueryPageSearch{Term: "x", Page: 1}),
		},
	})
}
