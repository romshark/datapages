...
| `app/fancy/datapagesgen/` | generated. Never edit. |
| `app/simple/` | app package: pages, actions, events, templates. Edit this. |
| `app/simple/datapagesgen/` | generated. Never edit. |
| `cmd/fancy/` | server entry point. Generated once, then yours. |
| `cmd/simple/` | server entry point. Generated once, then yours. |
...
- Never write JavaScript for application logic, open an SSE stream by hand, set a CSRF header or add the Datastar script.
