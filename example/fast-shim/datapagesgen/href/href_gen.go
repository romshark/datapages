...
// PageNoShim references /noshim/{$}
func PageNoShim() string { return "/noshim/" }

// PageNoShim2 references /noshim2/{$}
func PageNoShim2() string { return "/noshim2/" }

// PageSubpage references /subpage/{$}
func PageSubpage() string { return "/subpage/" }
