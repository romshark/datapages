...
func NewRepository() *domain.Repository {
	...
	users := map[string]domain.User{
		...
		"julianf92": {
			...
			AvatarImageURL: "https://images.pexels.com/photos/34074202/pexels-photo-34074202.jpeg?auto=compress&h=256",
		},
		"fabiberg": {
			PasswordHash:   "fabipass",
			AccountCreated: timestamp("2024-04-18T08:00:00Z"),
			Email:          "fabiberg@users.fake",
			AvatarImageURL: "https://images.pexels.com/photos/35520938/pexels-photo-35520938.jpeg?auto=compress&h=256",
		},
		"moritz-keilmann": {
	...
	for name, u := range users {
		id, err := repo.NewUser(
			ctx, name, u.AvatarImageURL, u.Email, u.PasswordHash,
		)
		if err != nil {
			panic(err)
		}
	...
	posts := []domain.Post{
		// category: Cars
		{
			ID:               "1001",
			CategoryID:       "cars",
			ImageURL:         "https://images.pexels.com/photos/810357/pexels-photo-810357.jpeg?auto=compress&h=512",
			MerchantUserName: "autohandel-maerz-regensburg",
		...
		},
		{
			ID:               "1002",
			CategoryID:       "cars",
			ImageURL:         "https://images.pexels.com/photos/100656/pexels-photo-100656.jpeg?auto=compress&h=512",
			MerchantUserName: "autohandel-maerz-regensburg",
		...
		},
		{
			ID:               "1004",
			CategoryID:       "cars",
			ImageURL:         "https://images.pexels.com/photos/6238437/pexels-photo-6238437.jpeg?auto=compress&h=512",
			MerchantUserName: "fabiberg",
		...
		},
		{
			ID:               "1005",
			CategoryID:       "cars",
			ImageURL:         "https://images.pexels.com/photos/175568/pexels-photo-175568.jpeg?auto=compress&h=512",
			MerchantUserName: "moritz-keilmann",
		...
		},
		{
			ID:               "1006",
			CategoryID:       "cars",
			ImageURL:         "https://images.pexels.com/photos/757181/pexels-photo-757181.jpeg?auto=compress&h=512",
			MerchantUserName: "johaness2442",
		...
		// category: Musical Instruments
		{
			...
			ImageURL:         "https://images.pexels.com/photos/1010519/pexels-photo-1010519.jpeg?auto=compress&h=512",
			MerchantUserName: "karl-heinz-schmidt",
		...
		},
		{
			ID:               "2009",
			CategoryID:       "musical-instruments",
			ImageURL:         "https://images.pexels.com/photos/2043571/pexels-photo-2043571.jpeg?auto=compress&h=512",
			MerchantUserName: "peter-lobert-mayer",
		...
		},
		{
			ID:               "20010",
			CategoryID:       "musical-instruments",
			ImageURL:         "https://images.pexels.com/photos/32218646/pexels-photo-32218646.jpeg?auto=compress&h=512",
			MerchantUserName: "peter-lobert-mayer",
		...
		},
		{
			ID:               "20011",
			CategoryID:       "musical-instruments",
			ImageURL:         "https://images.pexels.com/photos/164936/pexels-photo-164936.jpeg?auto=compress&h=512",
			MerchantUserName: "osna2",
		...
		// category: Clothing
		{
			ID:               "30012",
			CategoryID:       "clothing",
			ImageURL:         "https://images.pexels.com/photos/2356344/pexels-photo-2356344.jpeg?auto=compress&h=512",
			MerchantUserName: "gretschen",
		...
		},
		{
			ID:               "30013",
			CategoryID:       "clothing",
			ImageURL:         "https://images.pexels.com/photos/2464090/pexels-photo-2464090.jpeg?auto=compress&h=512",
			MerchantUserName: "hans-schwab90",
		...
		},
		{
			ID:               "30014",
			CategoryID:       "clothing",
			ImageURL:         "https://images.pexels.com/photos/13094233/pexels-photo-13094233.jpeg?auto=compress&h=512",
			MerchantUserName: "patricia-haas2",
		...
		// category: Electronics
		{
			...
			ImageURL:         "https://images.pexels.com/photos/32075199/pexels-photo-32075199.jpeg?auto=compress&h=512",
			MerchantUserName: "kaiy",
		...
		},
		{
			ID:               "40016",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/5961216/pexels-photo-5961216.jpeg?auto=compress&h=512",
			MerchantUserName: "kaiy",
		...
		},
		{
			ID:               "40017",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/17941534/pexels-photo-17941534.jpeg?auto=compress&h=512",
			MerchantUserName: "gehlert_gmbh",
		...
		},
		{
			ID:               "40018",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/19938246/pexels-photo-19938246.jpeg?auto=compress&h=512",
			MerchantUserName: "gehlert_gmbh",
		...
		},
		{
			ID:               "40019",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/32499807/pexels-photo-32499807.jpeg?auto=compress&h=512",
			MerchantUserName: "gehlert_gmbh",
		...
		},
		{
			ID:               "40020",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/16247537/pexels-photo-16247537.jpeg?auto=compress&h=512",
			MerchantUserName: "lorentz553",
		...
		},
		{
			ID:               "40021",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/30479285/pexels-photo-30479285.jpeg?auto=compress&h=512",
			MerchantUserName: "margarita-lehmann",
		...
		},
		{
			ID:               "40022",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/10774603/pexels-photo-10774603.jpeg?auto=compress&h=512",
			MerchantUserName: "jjk-331",
		...
		},
		{
			...
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/10774603/pexels-photo-10774603.jpeg?auto=compress&h=512",
			MerchantUserName: "laura-freimann66224",
			Title:            "Black Android Smartphone",
			Description:      "Used and in good working condition. Screen is clear with no visible cracks, casing shows normal wear from regular use. Google apps preinstalled and functioning, suitable for calls, messaging, browsing, and everyday apps. Ideal as a main phone or backup device. Phone only, no charger included. Sold as shown.",
			Price:            180,
			TimePosted:       timestamp("2025-11-23T13:55:00Z"),
		...
		},
		{
			ID:               "40024",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/19810744/pexels-photo-19810744.jpeg?auto=compress&h=512",
			MerchantUserName: "ines-schwarz",
		...
		},
		{
			ID:               "40026",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/821749/pexels-photo-821749.jpeg?auto=compress&h=512",
			MerchantUserName: "tilll",
		...
		},
		{
			ID:               "40027",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/1002636/pexels-photo-1002636.jpeg?auto=compress&h=512",
			MerchantUserName: "paola-fra",
		...
		},
		{
			ID:               "40028",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/279805/pexels-photo-279805.jpeg?auto=compress&h=512",
			MerchantUserName: "pipboy42",
		...
		},
		{
			ID:               "40029",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/2566027/pexels-photo-2566027.jpeg?auto=compress&h=512",
			MerchantUserName: "kerzer-j",
		...
		},
		{
			ID:               "40030",
			CategoryID:       "electronics",
			ImageURL:         "https://images.pexels.com/photos/7641488/pexels-photo-7641488.jpeg?auto=compress&h=512",
			MerchantUserName: "maroni",
	...
	for i, p := range posts {
		id, err := repo.NewPost(
			ctx, users[p.MerchantUserName].Name, p.Title, p.Description, p.CategoryID,
	...
	chats := []domain.Chat{
		{
			PostID:         posts[0].ID,
			SenderUserName: users["lorentz553"].Name,
		...
		{
			PostID:         posts[1].ID,
			SenderUserName: users["kaiy"].Name,
			Messages: []domain.Message{
				{
				...
				},
				{
					...
					SenderUserName: users[posts[1].MerchantUserName].Name,
		...
		},
		{
			...
			Messages: []domain.Message{
				...
				},
				{
					...
					SenderUserName: users[posts[2].MerchantUserName].Name,
		...
		{ // With response, all read
			...
			Messages: []domain.Message{
				...
				},
				{
					...
					SenderUserName: users[posts[4].MerchantUserName].Name,
	...
	for _, c := range chats {
		chatID, err := repo.NewChat(ctx, c.PostID, c.SenderUserName, c.Messages[0].Text)
		if err != nil {
			panic(err)
		}
		...
		merchantName := p.MerchantUserName
		...
		if !c.Messages[0].TimeRead.IsZero() {
			...
			readerID := merchantName
			if c.Messages[0].SenderUserName == merchantName {
		...
		for _, m := range c.Messages[1:] {
			msgID, err := repo.NewMessage(ctx, chatID, m.SenderUserName, m.Text)
			if err != nil {
				panic(err)
			}
			...
			if !m.TimeRead.IsZero() {
				...
				readerID := merchantName
				if m.SenderUserName == merchantName {
					readerID = c.SenderUserName
				}
