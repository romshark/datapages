...
// generated href package and read the values back out of the response, which
// puts the URL writer and the request parser in the same assertion: if either
// one changes its mind about an order, a name or a format, the round trip
...
//
// A page that returns its own head alongside its body. This is how a page
// carries a title and its own meta tags.
